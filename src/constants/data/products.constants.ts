export const PRODUCTS = [
  {
    ...
    description:
      "La montaña más alta de Argentina es el Aconcagua, con una altitud de 6.962 msnm. De hecho, también es el pico más alto de toda América y el segundo del mundo, solo por detrás de los que están situados en el Himalaya, como el Everest, que supera los 8.000.",
  ...
  },
  {
    ...
    description:
      "Con sus 6.893 metros de altitud es el volcán más alto del mundo, aunque no ha tenido erupciones en la historia reciente. El pico hace frontera con Chile, y está situado en una cadena volcánica de 60 kilómetros, que parte en el paso Fronterizo San Francisco y termina en el Nevado Tres Cruces. ",
  ...
  },
  {
    ...
    description:
      "Ocupa el tercer lugar de las montañas más altas de Argentina y se localiza a mitad camino entre las provincias de La Rioja (cara sur) y Catamarca (cara norte).  A 16 km está el cráter Corona del Inca, que alberga en su interior un bonito lago navegable.",
  ...
  },
  {
    ...
    description:
      "Situado en la provincia de San Juan, está dentro de un macizo que lo forman otras importantes montañas como Pico Polaco, La Mesa, Alma Negra y Ramada.",
  ...
  },
  {
    ...
    description:
      "Está situado en la provincia de La Rioja, y también es conocido como Cerro Bonete Chico. A 12 km al norte está el Centro Bonete Grande, y como curiosidad, es más pequeño. Destaca por ser uno de los volcanes más altos del mundo.",
  ...
  },
  {
    ...
    description:
      "Deslizarte en caudalosos ríos a una velocidad implacable con un grupo de amigos, es una de las actividades más divertidas y que despierta gran adrenalina en quienes la practican. El rafting es un deporte ideal para quienes viajan en grupo ya que les permitirá disfrutar a todos al mismo tiempo, la aventura de sortear diferentes obstáculos y caminos lejos de tierra firme.",
